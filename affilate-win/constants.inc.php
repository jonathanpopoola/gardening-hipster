...
// AW API constants
define('API_USERNAME', '213679'); // AdvertiserService and PublisherService APIs only; your advertiser or publisher ID (for example: 1234 or 1234567)
define('API_PASSWORD', 'c82ce7d85686b81e69732138b4d7db51422de5d069e882da'); // For the Advertiser Service API found under Settings / API Credentials / Hash
...
// PS API constants
define('API_KEY', 'ee3b419770ac3b72db0d58c363b41022'); // ProductServe API only; activated by the publisher and once that has been done the password can be found under Settings / Manage API Credentials / ProductServe API Password
